...
object ItemEntryDestination : NavigationDestination {
    ...
    override val titleRes = R.string.add_a_note
}
...
fun ItemInputForm(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.name_of_the_note)) },
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(R.string.description_of_your_note)) },
...
private fun ItemEntryScreenPreview() {
    NotebookForNotesThemeTheme {
        ItemEntryBody(itemUiState = ItemUiState(
            ItemDetails(
                name = "Note name",
                description = "sdfsdfsdfsdfsdfsdfasdfsdf" +
                        "dsfdsfgsdfgsdfgsfgsfgsfgsfgsfgs fg sfgfg    gggg ggggf   ss    ddddddd",
            )
